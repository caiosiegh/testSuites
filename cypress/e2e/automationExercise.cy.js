describe('Suíte de Testes para o Site "Automation Exercise"', ()=>{
    ...
    it('Registrar um usuário', () => {
        ...
        cy.get('input[data-qa="signup-email"]').type('teste7@siegh.com')
        cy.get('button[data-qa="signup-button"]').click()
        cy.get('h2').eq(0).find('b').should('have.text', 'Enter Account Information')
    ...
    it('Deslogar Usuário', ()=> {
        ...
        cy.get('div[class="login-form"] h2').contains('Login to your account').should('be.visible')
    })
    ...
    it('Formulário contate-nos', ()=> {
        ...
        cy.get('div[class="col-sm-12"] h2').contains('Contact').should('be.visible')
        cy.get('input[placeholder="Name"]').type('Siegh')
    ...
    it('Verificar a página "Test Cases"', ()=> {
        cy.visit('https://automationexercise.com')
        cy.title().should('eq', 'Automation Exercise')
        cy.get('.nav.navbar-nav').contains('Test Cases').should('be.visible').click()
        cy.get('h2[class="title text-center"] b').contains("Test Cases").should('be.visible')
    })
    ...
    it('Verificar a página "Todos os produtos" e a página "Detalhes do Produto"', ()=> {
        ...
        cy.get('.product-information').contains('h2', 'Blue Top').should('be.visible')
        ...
        cy.get('.product-information').contains('Availability: In Stock').should('be.visible')
        cy.get('.product-information').contains('Condition: New').should('be.visible')
    ...
    it('Adicionar produtos no carrinho', ()=> {
        ...
        cy.get('.btn.btn-success.close-modal.btn-block').contains('Continue Shopping').click()
    ...
    it('Fazer pedido: Registre-se durante o checkout', ()=> {
        ...
        cy.get('#submit').click()
        cy.get('body').contains('Congratulations! Your order has been confirmed!').should('be.visible')
        cy.get('a[href="/delete_account"]').click()
        cy.get('h2').find('b').should('have.text', 'Account Deleted!')
        cy.get('.btn.btn-primary').click()
        cy.title().should('eq', 'Automation Exercise')
    ...
    it('Verifique os detalhes do endereço na página de checkout', ()=> {
        ...
        cy.get('h2').contains('New User Signup!').should('be.visible')
        cy.get('input[placeholder="Name"]').type('Siegh')
        cy.get('input[data-qa="signup-email"]').type('teste29@siegh.com')
        cy.get('button[data-qa="signup-button"]').click()
        cy.get('h2').eq(0).find('b').should('have.text', 'Enter Account Information')
        cy.get('#id_gender1').check()
        cy.get('#password').type('123456')
        ...
        cy.get('.btn.btn-default.check_out').click()
        cy.get('ul[id="address_delivery"] li[class="address_firstname address_lastname"]').should('have.text', 'Mr. Teste Legal')
        cy.get('ul[id="address_delivery"] li[class="address_address1 address_address2"]').should('have.text', 'sieghLTDARua talNumero tal')
        cy.get('ul[id="address_invoice"] li[class="address_firstname address_lastname"]').should('have.text', 'Mr. Teste Legal')
    })
    ...
    it('Baixe a fatura após o pedido de compra', ()=> {
        ...
        cy.get('h2').contains('New User Signup!').should('be.visible')
        cy.get('input[placeholder="Name"]').type('Siegh')
        cy.get('input[data-qa="signup-email"]').type('teste33@siegh.com')
        cy.get('button[data-qa="signup-button"]').click()
        cy.get('h2').eq(0).find('b').should('have.text', 'Enter Account Information')
        cy.get('#id_gender1').check()
        cy.get('#password').type('123456')
    ...
    it.only('Verifique a rolagem para cima usando o botão "Seta" e a funcionalidade de rolagem para baixo', ()=> {
        cy.visit('https://automationexercise.com')
        cy.title().should('eq', 'Automation Exercise')
        cy.get('h2').contains('Subscription').and('be.visible')
        cy.get('h2').contains('Full-Fledged practice website for Automation Engineers').scrollIntoView()
    })

    it.only('Verifique a rolagem para cima sem usar o botão "Seta" e a funcionalidade de rolagem para baixo', ()=> {
        cy.visit('https://automationexercise.com')
        cy.title().should('eq', 'Automation Exercise')
        cy.get('h2').contains('Subscription').and('be.visible')
        cy.get('h2').contains('Full-Fledged practice website for Automation Engineers').scrollIntoView()
